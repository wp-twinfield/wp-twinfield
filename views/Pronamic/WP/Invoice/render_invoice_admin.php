<?php wp_twinfield_admin_query_nav( 'twinfield_invoice_id' ); ?>
<?php if ( ! filter_has_var( INPUT_GET, 'twinfield_invoice_id' ) ) : ?>
<form method="GET">
...
<?php if ( filter_has_var( INPUT_GET, 'twinfield_invoice_id' ) && filter_input( INPUT_GET, 'twinfield_invoice_id', FILTER_VALIDATE_INT ) ) : ?>
    ...
    <?php if ( $invoice_factory->getResponse()->isSuccessful() ) : ?>
        <h2><?php printf( __( 'Invoice %d', 'twinfield' ), $invoice->getInvoiceNumber() ); ?></h2>
