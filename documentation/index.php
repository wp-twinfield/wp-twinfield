...
FROM
	...
	wp_lookup_offices AS office
		...
		LEFT JOIN
	wp_lookup_periods AS period
			ON transaction.period_id = period.id
		LEFT JOIN
...
Dimension type of balances accounts is BAS.',
		...
		<p>
			<a href="https://accounting.twinfield.com/webservices/documentation/#/ApiReference/Miscellaneous/Period">https://accounting.twinfield.com/webservices/documentation/#/ApiReference/Miscellaneous/Period</a>
		</p>
